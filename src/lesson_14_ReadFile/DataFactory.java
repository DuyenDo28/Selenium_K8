...
public class DataFactory {
    ...
    public static void savePersonList(List<Person> personList, String filePath) {
        ...
        try (
            ...
            for (Person person : personList) {
                ...
                String dataLine =
                        personName.concat(";").concat(String.valueOf(personAge)).concat(";").concat(String.valueOf(personSalary));
    ...
    public static void main(String[] args) {
        ...
        String dataFileRelativePath = "\\src\\lesson_14_ReadFile\\person.txt";
        String dataFileAbsolutePath = System.getProperty("user.dir").concat(dataFileRelativePath);

        Person teo = new Person("teo", 20, 10000);
        Person ti = new Person("ti", 22, 11000);
